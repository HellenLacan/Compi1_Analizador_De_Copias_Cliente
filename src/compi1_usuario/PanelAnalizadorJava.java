 ...
 * @author Hellen
 */
public class PanelAnalizadorJava extends javax.swing.JPanel {

    public static String Path1 = "";
    public static String Path2 = "";

    /**
     * Creates new form PanelAnalizadorJava
     */
    public PanelAnalizadorJava() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/cerrar-icono-6397-16.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (responce == JFileChooser.APPROVE_OPTION) {
            ...
            //miArchivo.setPath(fc.getSelectedFile().toString());    }//GEN-LAST:event_jButton1ActionPerformed
        }
    }
   ...
   /*     if ((getPath1().equals("") && getPath2().equals("")) || (getPath1() != "" && getPath2() == "")|| (getPath1() == "" && getPath2() != "")) {
            JOptionPane.showMessageDialog(null, "Debe de seleccionar dos proyectos","Error",JOptionPane.ERROR_MESSAGE);
        } else if (!getPath1().equals("") && !getPath2().equals("") || (!getPath1().equals(null) && !getPath2().equals(null))){
*/
            try {
